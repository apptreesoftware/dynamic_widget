...
class RaisedButtonParser extends WidgetParser {
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    var raisedButton = ElevatedButton(
      style: ButtonStyle(
        ...
        padding: MaterialStateProperty.all(map.containsKey('padding')
            ? parseEdgeInsetsGeometry(map['padding'])
            : null),
        foregroundColor: MaterialStateProperty.all(map.containsKey('textColor')
  ...
  Map<String, dynamic> export(Widget? widget, BuildContext? buildContext) {
    ...
    var padding = realWidget.style?.padding?.resolveAll() as EdgeInsets?;
    ...
    return <String, dynamic>{
      ...
      "color": realWidget.style?.backgroundColor != null
          ? realWidget.style?.backgroundColor
              ...
              .toRadixString(16)
          : null,
      "elevation": realWidget.style?.elevation?.resolveAll(),
      "padding": padding != null
          ? "${padding.left},${padding.top},${padding.right},${padding.bottom}"
          : null,
      "textColor": realWidget.style?.foregroundColor?.resolveAll() != null
